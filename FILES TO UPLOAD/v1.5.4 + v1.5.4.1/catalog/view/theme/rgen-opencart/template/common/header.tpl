		...
		******************************/
		?><div id="header"<?php if ($this->config->get('RGen_logoPosition_status') == 1) { ?> class="logo-in-header"<?php } ?>>
			...
			<div id="search">
				...
				<?php if ($filter_name) { ?>
				<span class="search-box"><input type="text" name="filter_name" value="<?php echo $filter_name; ?>" /></span>
				<?php } else { ?>
				<span class="search-box"><input type="text" name="filter_name" value="<?php echo $text_search; ?>" onclick="this.value = '';" onkeydown="this.style.color = '#000000';" /></span>
				<?php } ?>
			</div>
