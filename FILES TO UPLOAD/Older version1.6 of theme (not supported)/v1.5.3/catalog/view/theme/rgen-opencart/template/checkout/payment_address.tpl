	...
	<div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
		<table class="form">
			...
			<tr style="display: <?php echo ($company_id_display ? 'table-row' : 'none'); ?>;">
				<td><?php echo $entry_company_id; ?> <span style="display: <?php echo ($company_id_required ? 'table-row' : 'none'); ?>;" class="required">*</span></td>
				<td><input type="text" name="company_id" value="" class="large-field" /></td>
			</tr>
			<tr style="display: <?php echo ($tax_id_display ? 'table-row' : 'none'); ?>;">
				<td><?php echo $entry_tax_id; ?> <span style="display: <?php echo ($tax_id_required ? 'table-row' : 'none'); ?>;" class="required">*</span></td>
...
$('#payment-address select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			val = $('option:selected','#payment-address select[name=\'zone_id\']').text();
			$('#payment-address select[name=\'zone_id\']').parent().find('span.select').text(val);	
