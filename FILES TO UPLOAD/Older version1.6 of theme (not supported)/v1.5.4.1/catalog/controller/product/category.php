...
class ControllerProductCategory extends Controller {  
	public function index() { 
		...
		$this->document->addScript('catalog/view/theme/rgen-opencart/js/jquery.bxSlider.min.js');
		$this->document->addStyle('catalog/view/theme/rgen-opencart/stylesheet/bxSlider.css');
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				...
				$this->data['categories'][] = array(
					...
					'pic'	=> $this->model_tool_image->resize($result['image'], $this->config->get('config_image_category_width'), $this->config->get('config_image_category_height'))
				);
			}
