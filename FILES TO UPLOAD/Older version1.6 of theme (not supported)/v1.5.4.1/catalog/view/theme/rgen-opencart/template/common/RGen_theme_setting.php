...
.store-home #slidshow-box .bx-prev {
	background-color:#<?php echo $this->config->get('RGen_globalColour'); ?> !important;
	}
<?php } ?>

<?php if($this->config->get('RGen_globalColourRing') != ''){ ?>
.slideshow .nivo-controlNav a { box-shadow:0px 0px 0px 2px <?php $this->config->get('RGen_globalColourRing')?> !important; } 
<?php } ?>
...
<?php } else { ?>
	-webkit-box-shadow: 0px 0px 8px 0px <?php echo $this->config->get('RGen_pageShadow'); ?> !important;'
	box-shadow: 0px 0px 8px 0px <?php echo $this->config->get('RGen_pageShadow'); ?> !important;
<?php } ?>
}
...
.thumb-wrapper .bx-prev {
	<?php if($this->config->get('RGen_arrowBg') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_arrowBg'); ?> !important;<?php } ?>
	<?php
...
.thumb-wrapper .bx-prev:hover {
	<?php if($this->config->get('RGen_arrowBg_hover') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_arrowBg_hover'); ?> !important;<?php } ?>
	<?php
	if($this->config->get('RGen_arrowBgRing') != ''){
...
#header #welcome a,
#header .links a {
	color:#<?php echo $this->config->get('RGen_Header_Link'); ?> !important;
	}
<?php } ?>
...
#header .links a:hover {
	color:#<?php echo $this->config->get('RGen_Header_Link_hover'); ?> !important;
	}
<?php } ?>
<?php if($this->config->get('RGen_Header_text') != ''){ ?>
#header #welcome {
	color:#<?php echo $this->config->get('RGen_Header_text'); ?> !important;
	}
<?php } ?>
...
.home-btn { 
	<?php if($this->config->get('RGen_homeBt') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_homeBt'); ?> !important;<?php } ?>
	<?php
...
.home-btn:hover { 
	<?php if($this->config->get('RGen_homeBt_hover') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_homeBt_hover'); ?> !important; <?php } ?>
	}

#header .button-search {
	<?php if($this->config->get('RGen_searchBt') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_searchBt'); ?> !important;<?php } ?>
	<?php
...
#header .button-search:hover {
	...
	<?php if($this->config->get('RGen_searchBt_hover') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_searchBt_hover'); ?> !important;<?php } ?>
	}


/* PRODUCT BOX */
<?php if($this->config->get('RGen_RefinCateHdBg') != ''){ ?>
.refine-cate h2 { background-color:#<?php echo $this->config->get('RGen_RefinCateHdBg'); ?> !important; }
<?php } ?>
...
.product-list .prd-block .info-wrp .price,
.product-info .price {
	<?php if($this->config->get('RGen_PriceBg') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_PriceBg'); ?> !important;<?php } ?> 
	<?php if($this->config->get('RGen_Price') != ''){ ?>color:#<?php echo $this->config->get('RGen_Price'); ?> !important;<?php } ?> 
	}
...
.product-list .buy-option .cart-bt {
	<?php if($this->config->get('RGen_cartBt') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_cartBt'); ?> !important;<?php } ?> 
	<?php
...
.product-list .buy-option .cart-bt:hover {
	<?php if($this->config->get('RGen_cartBt_hover') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_cartBt_hover'); ?> !important;<?php } ?> 
	<?php
...
.store-home #slidshow-box .bx-next, 
.store-home #slidshow-box .bx-prev {
	<?php if($this->config->get('RGen_featuredArrow') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_featuredArrow'); ?> !important;<?php } ?> 
	}
.store-home #slidshow-box .bx-next:hover, 
.store-home #slidshow-box .bx-prev:hover {
	<?php if($this->config->get('RGen_featuredArrow_hover') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_featuredArrow_hover'); ?> !important;<?php } ?> 
	}
...
.store-home #slidshow-box .price {
	<?php if($this->config->get('RGen_featuredPriceBg') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_featuredPriceBg'); ?> !important;<?php } ?> 
	}
.store-home #slidshow-box .price-new {
	<?php if($this->config->get('RGen_featuredPrice') != ''){ ?>color: #<?php echo $this->config->get('RGen_featuredPrice'); ?> !important;<?php } ?> 
	}
.store-home #slidshow-box .price-old {
	<?php if($this->config->get('RGen_featuredPriceOld') != ''){ ?>color: #<?php echo $this->config->get('RGen_featuredPriceOld'); ?> !important;<?php } ?> 
	}
.store-home #slidshow-box .prd-block .cart-bt {
	<?php if($this->config->get('RGen_featuredCrtBt') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_featuredCrtBt'); ?> !important;<?php } ?> 
	<?php
...
<?php } ?>
.footer-bt a { 
	<?php if($this->config->get('RGen_FooterSocial') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_FooterSocial'); ?> !important;<?php } ?> 
	<?php
	if($this->config->get('RGen_featuredCrtBtRing_hover') != ''){
		echo 'box-shadow: 0px 0px 0px 8px '.$this->config->get('RGen_FooterSocialRing').';';
	} ?>
	}
.footer-bt a:hover { 
	<?php if($this->config->get('RGen_FooterSocial_hover') != ''){ ?>background-color:#<?php echo $this->config->get('RGen_FooterSocial_hover'); ?> !important; <?php } ?> 
	<?php
