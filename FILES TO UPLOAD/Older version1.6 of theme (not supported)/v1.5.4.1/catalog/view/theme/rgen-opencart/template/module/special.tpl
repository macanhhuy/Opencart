<?php if ($this->config->get('RGen_SlideShow_Mod') == 'special' && $getRoute == 'common/home') { ?>
...
$(document).ready(function(){
	...
	function hoverSet(){
		var H = $('#special-prd<?php echo $module; ?>, #slidshow-box').find('.info-wrp').outerHeight();
		$('#special-prd<?php echo $module; ?> .prd-block, #slidshow-box .prd-block').hover(
			function(){
