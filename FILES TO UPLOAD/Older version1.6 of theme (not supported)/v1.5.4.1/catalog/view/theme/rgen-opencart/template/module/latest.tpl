<?php if ($this->config->get('RGen_SlideShow_Mod') == 'latest' && $getRoute == 'common/home') { ?>
<div class="box latest-prd slidshow-prd" id="slidshow-box">
<?php }else { ?>
...
$(document).ready(function(){
	...
	function hoverSet(){
		var H = $('#latest-prd<?php echo $module; ?>, #slidshow-box').find('.info-wrp').outerHeight();
		$('#latest-prd<?php echo $module; ?> .prd-block, #slidshow-box .prd-block').hover(
			function(){
