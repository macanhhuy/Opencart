	...
	<div class="content-body">
		...
		<div class="wishlist-info m0">
			<table>
				<thead>
					<tr>
						<td class="image" colspan="2"><?php echo $column_name; ?><?php //echo $column_image; ?></td>
				...
				<tbody id="wishlist-row<?php echo $product['product_id']; ?>">
					<tr>
						...
						<td class="action">
							<input class="cart-bt" type="button" title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');"  /><br />
