<?php if ($this->config->get('RGen_SlideShow_Mod') == 'best' && $getRoute == 'common/home') { ?>
...
$(document).ready(function(){
	...
	function hoverSet(){
		var H = $('#bestseller-prd<?php echo $module; ?>, #slidshow-box').find('.info-wrp').outerHeight();
		$('#bestseller-prd<?php echo $module; ?> .prd-block, #slidshow-box .prd-block').hover(
			function(){
