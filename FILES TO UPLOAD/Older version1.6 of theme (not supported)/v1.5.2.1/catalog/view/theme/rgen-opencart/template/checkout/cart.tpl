			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="panes">
						...
						<div id="shipping" class="pane" style="display:block;">
							<p><?php echo $text_shipping_detail; ?></p>
							<label for="country_id"><?php echo $entry_country; ?> <span class="required">*</span></label>
							<select name="country_id" onchange="$('select[name=\'zone_id\']').load('index.php?route=checkout/cart/zone&country_id=' + this.value + '&zone_id=<?php echo $zone_id; ?>');">
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '  <div class="buttons"><input type="submit" value="<?php echo $button_shipping; ?>" class="button" /></div>';				
				html += '</form>';
				html += '</div>';
...
$('select[name=\'zone_id\']').load('index.php?route=checkout/cart/zone&country_id=<?php echo $country_id; ?>&zone_id=<?php echo $zone_id; ?>', function() {
	val = $('option:selected',this).text();
	$(this).parent().find('span.select').text(val);
});

$('select[name="country_id"]').change(function() {
	$('select[name=\'zone_id\']').load('index.php?route=checkout/cart/zone&country_id=' + this.value + '&zone_id=<?php echo $zone_id; ?>', function() {
		val = $('option:selected',this).text();
		$(this).parent().find('span.select').text(val);
	});
});
