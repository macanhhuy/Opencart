...
class ControllerModuleSlideshow extends Controller {
	protected function index($setting) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/js/jquery.nivo.slider.pack.js')) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/nivo-slider.css')) {
